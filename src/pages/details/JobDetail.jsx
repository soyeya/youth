...
const Jobdetails = () => {
  ...
  /**
   * 와일드카드 라우트 `/details/job/*` 에서 실제 정책명을 추출.
  ...
  const link = `/details/job/${encodeURIComponent(values)}`;
  ...
  const loadDetail = async () => {
    ...
    try {
      ...
      console.log('JobDetail 로드 오류:', err.message || err);
      setNotFound(true);
    } finally {
      finishLoading();
    }
  ...
  const pageHeader = <Title title={'일자리 정책 상세'} />;
