...
const EducationDetails = () => {
  ...
  /**
   * 와일드카드 라우트 `/details/education/*` 에서 실제 정책명을 추출.
  ...
  const link = `/details/education/${encodeURIComponent(values)}`;
  ...
  const loadDetail = async () => {
    ...
    try {
      ...
      console.log('EducationDetail 로드 오류:', err.message || err);
      setNotFound(true);
    } finally {
      finishLoading();
    }
  ...
  const pageHeader = <Title title={'교육 정책 상세'} />;
