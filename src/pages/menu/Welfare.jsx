...
const Welfare = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const filtered = list.filter((item) => item.bscPlanPlcyWayNo === '004');
      ...
      console.log('복지 데이터 로드 오류:', err.message || err);
      setRawItems([]);
    } finally {
      finishLoading();
    }
