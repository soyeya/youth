...
const Residence = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const filtered = list.filter((item) => item.bscPlanPlcyWayNo === '002');
      ...
      console.log('주거 데이터 로드 오류:', err.message || err);
      setRawItems([]);
    } finally {
      finishLoading();
    }
